            ...
            <div class="card-footer text-muted container">
                <div class="row">
                    ...
                    <#if message.author.id == currentUserId>
                        ...
                        <a class="col btn btn-primary" href="/delete-message/${message.author.id}?id=${message.id}">
                            X
                        </a>

                    </#if>
<#--                    <#if message.author.id == currentUserId>-->
<#--                        <a class="col btn btn-primary" href="/delete-user-messages/${message.author.id}?message=${message.id}">-->
<#--                            X-->
<#--                        </a>-->
<#--                    </#if>-->
                </div>
